                ...
                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="min-width: 5rem;width: 5rem">
                                                @auth
                                                    <a class="btn-sm btn-primary bg-secondary" id="destroy{{ $data->id }}"
                                                        href="{{ route('delete_alumni_sudah_bekerja', $data->id) }}"
                                                        role="button"><i class="fa fa-trash"></i></a>
                                                    <a class="btn-sm btn-primary" id="edit{{ $data->id }}"role="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal_edit_sudah_bekerja_{{ $data->no }}"><i
                    ...
                    <div class="tab-pane fade" id="nav-berwirausaha" role="tabpanel" aria-labelledby="nav-berwirausaha-tab">
                        {{-- <form action="" method="POST">
                                            ...
                                            <td style="min-width: 5rem;width: 5rem">
                                                @auth
                                                    <a class="btn-sm btn-primary bg-secondary"
                                                        id="destroy{{ $data->id }}"
                                                        href="{{ route('delete_alumni_wirausaha', $data->id) }}"
                                                        role="button"><i class="fa fa-trash"></i></a>
                                                    <a class="btn-sm btn-primary" id="edit{{ $data->id }}"role="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal_edit_wirausaha_{{ $data->no }}"><i
                                                        class="fa fa-pencil"></i></a> @endauth
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            @auth
                                <a class="btn-sm btn-primary" id="tambah" href="#" role="button"
                                    data-bs-toggle="modal" data-bs-target="#modal_form_wirausaha">&plus;</a>
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 5rem;width: 5rem">
                                                @auth
                                                    <a class="btn-sm btn-primary bg-secondary"
                                                        id="destroy{{ $data->id }}"
                                                        href="{{ route('delete_alumni_lanjut_pendidikan', $data->id) }}"
                                                        role="button"><i class="fa fa-trash"></i></a>
                                                    <a class="btn-sm btn-primary" id="edit{{ $data->id }}"role="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal_edit_lanjut_pendidikan_{{ $data->no }}"><i
                                                        class="fa fa-pencil"></i></a> @endauth
                                            </td>
                                        </tr>
                                        <tr>

            ...
            <div class="card-body">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-belum-bekerja-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-belum-bekerja" type="button" role="tab"
                            aria-controls="nav-belum-bekerja" aria-selected="true">Belum
                            Bekerja</button>
                        <button class="nav-link" id="nav-sudah-bekerja-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-sudah-bekerja" type="button" role="tab"
                            aria-controls="nav-sudah-bekerja" aria-selected="false">Sudah
                            Bekerja</button>
                        <button class="nav-link" id="nav-berwirausaha-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-berwirausaha" type="button" role="tab"
                            aria-controls="nav-berwirausaha" aria-selected="false">Berwirausaha</button>
                        <button class="nav-link" id="nav-lanjut-pendidikan-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-lanjut-pendidikan" type="button" role="tab"
                            aria-controls="nav-lanjut-pendidikan" aria-selected="false">Lanjut
                            Pendidikan</button>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-belum-bekerja" role="tabpanel"
                        ...
                        <form action="{{ route('add_alumni_belum_bekerja') }}" method="POST">
                            ...
                            @guest
                                <button type="submit"
                                    class="btn btn-primary position-relative top-50 start-50">Kirim</button>
                            @endguest
                            <br>
                            <br>
                        </form>
                                            ...
                                            <td style="min-width: 5rem;width: 5rem">
                                                @auth
                                                    ...
                                                    <a class="btn-sm btn-primary" id="edit{{ $data->id }}"role="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal_edit_{{ $data->no }}"><i
                                                        class="fa fa-pencil"></i></a> @endauth
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="d-none d-lg-block" style="">
                    ...
                    <div class="tab-pane fade" id="nav-berwirausaha" role="tabpanel"
                        aria-labelledby="nav-berwirausaha-tab">wirausaha
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col">
                                        ...
                                        @if ($data->pilihan == '')
                                            <input type="text" class="form-control mb-1"
                                                name="bank{{ $data->no }}" {{ $data->wajib == 1 ? 'required' : '' }}>
                                        @else
                                            @foreach (explode(';', $data->pilihan) as $info)
                                                <div class="form-check mb-0">
                                                    <input class="form-check-input gandaOpsi{{ $data->no }}"
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="col-auto">
                                        {{ $no_urut_belum_bekerja + 1 }}.
                                        <input type="hidden" name="no" value="{{ $no_urut_belum_bekerja + 1 }}">
                                    </td>
                                    <td>

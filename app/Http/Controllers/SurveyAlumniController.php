...
class SurveyAlumniController extends Controller
{
    ...
    public function store(Request $request, $kategori)
    {
        ...
        if ($kategori == 'belum_bekerja') {
            SurveyAlumniBelumBekerja::create($model);
        } elseif ($kategori == 'sudah_bekerja') {
            SurveyAlumniSudahBekerja::create($model);
        } elseif ($kategori == 'berwirausaha') {
            SurveyAlumniWirausaha::create($model);
        } elseif ($kategori == 'lanjut_pendidikan') {
            SurveyAlumniLanjutPendidikan::create($model);
        }
    }
    ...
    public function show(SurveyAlumni $survey_Alumni, Request $request)
    {
        ...
        $data_user = [
            'nama' => UserAlumni::where('nim', $request->input('nim'))->pluck('nama')->first(),
            'nim' => $request->input('nim'),
            'prodi' => UserAlumni::where('nim', $request->input('nim'))->pluck('prodi')->first(),
